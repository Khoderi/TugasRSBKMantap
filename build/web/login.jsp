<%-- 
    Document   : login
    Created on : Nov 20, 2019, 8:35:49 PM
    Author     : Khoderisasi
--%>
...
<body>
    <div class="container">
        <div class="jumbotron row">
          ...
          <h4>Modul RSBK - Kelompokxx</h4></center>
        </div>
            ...
            <div class="col-md-4 col-md-offset-4 daftar">
              ...
              <form method="POST" action="./LoginServlet">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Username" name="nama" type="text" autofocus />
                </div>
                <div class="form-group">
