<%-- 
    Document   : homeAdmin
    Created on : Nov 20, 2019, 8:36:40 PM
    Author     : Khoderisasi
--%>
...
<div class="container">
	...
	<p>Modul RSBK - Kelompokxx</p>
        <h5>Selamat Datang, <%=session.getAttribute("nama")%></h6></center>
    </div>
	...
	<div class="col-md-9 daftar">
            <form action="./BukuServlet" method="POST">
                ...
                <tr>
                <td>Id Buku</td>
                <td><input class="form-control" type="text" name="id_buku" value="${buku.id_buku}" /></td>
                </tr>
                <tr>
                <td>Judul</td>
                <td><input class="form-control" type="text" name="judul" value="${buku.judul}" /></td>
                </tr>
                <tr>
                <td>Penerbit</td>
                <td><input class="form-control" type="text" name="penerbit" value="${buku.penerbit}" /></td>
                </tr>
                <tr>
                <td>Halaman</td>
                <td><input class="form-control" type="text" name="halaman" value="${buku.halaman}" /></td>
                </tr>
                <tr>
                <td>Stok</td>
                <td><input class="form-control" type="text" name="stok" value="${buku.stok}" /></td>
                </tr>
                <tr>
                <td colspan="2">
		...
		<table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <s:forEach items="${allBuku}" var="buku">
                    <tr>
                        <td>${buku.id_buku}</td>
			<td>${buku.judul}</td>
                        <td>${buku.penerbit}</td>
